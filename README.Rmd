...
- yr_bike_recomendation: If you ride your bike to work, it might be nice to know if it is going to rain or be really windy. You can create tests for minimum and/or maximum values and get a written recommendation or a Boolean.
...
I recommend that you supply the place_url instead like this, as the call above is rather slow. You can finde the url by using the search function or just copy the url from the yr.no website.
...
The links to the XML files are static, but you need to do a bit of work to get the links. Use the yr_search function or find the links manually on the [yr.no](https://www.yr.no).
